...
export default function ImportCapabilities() {
  ...
  return (
    ...
    >
      {/* Icon */}
      <div className="w-[4.5rem] h-[4.5rem] rounded-[1rem] flex items-center justify-center transition-all duration-500 bg-[#f3f3f3] text-[#ff4d2d] group-hover:bg-[#2552c7] group-hover:text-white">
        <Icon className="text-[1.8rem]" />
      </div>
